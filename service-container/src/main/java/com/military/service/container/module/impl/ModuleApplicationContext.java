...
public class ModuleApplicationContext extends AbstractXmlApplicationContext implements  WebApplicationContext {
     ...
     */
    public ModuleApplicationContext(String configLocation) throws BeansException {
     ...
     * @throws BeansException if context creation failed
     */
    public ModuleApplicationContext(String... configLocations) throws BeansException {
     ...
     * @throws BeansException if context creation failed
     */
    public ModuleApplicationContext(String[] configLocations, ApplicationContext parent) throws BeansException {
     ...
     * @see #refresh()
     */
    public ModuleApplicationContext(String[] configLocations, boolean refresh) throws BeansException {
     ...
     * @see #refresh()
     */
    public ModuleApplicationContext(String[] configLocations, boolean refresh, ApplicationContext parent)
     ...
     */
    public ModuleApplicationContext(String path, Class<?> clazz) throws BeansException {
     ...
     * @see org.springframework.beans.factory.xml.XmlBeanDefinitionReader
     */
    public ModuleApplicationContext(String[] paths, Class<?> clazz) throws BeansException {
     ...
     * @see org.springframework.beans.factory.xml.XmlBeanDefinitionReader
     */
    public ModuleApplicationContext(String[] paths, Class<?> clazz, ApplicationContext parent)
            throws BeansException {
